...
def pregunta_04():
    ...
    """
    return tbl0.groupby(["_c1"]).mean(["_c2"])["_c2"]
...
def pregunta_10():
    ...
    return tbl0.groupby(["_c1"]).agg({"_c2": ":".join})
...
def pregunta_11():
    ...
    return tbl1.groupby(["_c0"]).agg({"_c4": ",".join})
...
def pregunta_12():
    ...
    return tbl2.groupby(["_c0"]).agg({"_c5": ",".join})
...
def pregunta_13():
    ...
    """
    return pd.merge(tbl0, tbl2, on = ["_c0"]).groupby(["_c1"]).sum()["_c5b"]
